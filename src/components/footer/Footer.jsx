          ...
          <div className="row">
            <div className="col-md-4 mb-5">
              ...
              <div className="d-flex flex-column justify-content-start">
                ...
                <Link className="text-dark mb-2" href="/popular_books">
                  <i className="fa fa-angle-right mr-2"></i>Popular Books
                </Link>
                <Link className="text-dark mb-2" href="/new_releases">
                  <i className="fa fa-angle-right mr-2"></i>New Releases
                </Link>
        ...
        <div className="col-md-6 px-xl-0">
          <p className="mb-md-0 text-center text-md-left text-dark">
            ...
            <Link
              ...
              href="https://eldorado-iota.vercel.app"
              target="_blank"
            >
              El Dorado
            </Link>
